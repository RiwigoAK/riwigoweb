...
class ModelCatalogCategory extends Model {
	...
	public function getTotalMerchantsByCategoryId($category_id = 0, $city_id) {
		
		
	    $sql ="SELECT * FROM " . DB_PREFIX . "merchant_products mp 
		LEFT JOIN " . DB_PREFIX . "merchant_description md ON (mp.merchant_id = md.merchant_id) 
		...
		AND md.city_id ='".(int)$city_id."' group by md.merchant_id";
