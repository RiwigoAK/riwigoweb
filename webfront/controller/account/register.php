...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$this->document->addStyle('webfront/view/theme/default/stylesheet/login.css');
		...
		$data['text_regsiter'] = $this->language->get('text_regsiter');
		...
		$data['entry_captch_code'] = $this->language->get('entry_captch_code'); 
		
                $data['button_register'] = $this->language->get('button_register');
                $data['button_facebook'] = $this->language->get('button_facebook');
                $data['button_googleplus'] = $this->language->get('button_googleplus');
	...
	public function validate() {
            ...
            if((utf8_strlen($this->request->post['password']) < 4) || (utf8_strlen($this->request->post['password']) > 20)) {
                    $json['password'] = $this->language->get('password');
            }elseif ($this->request->post['frmUserCPassword'] != $this->request->post['password']) {
                    $json['password'] = $this->language->get('error_confirm');
            }
